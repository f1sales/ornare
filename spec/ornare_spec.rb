  ...
  context 'when email is from website' do
    ...
    context 'when is to SP' do
      ...
      let(:email) do
        ...
        email.body = "De: Marcio Klepacz <marcioklepacz@gmail.com> Assunto: Vendas / Orçamento Telefone: 11981587311 Estado: SP Endereço: Rua Bahia, 543, apt 232 Newsletter: Não Corpo da mensagem: Lead Teste" 
